...
var Studio = (function () {
    Counter("魔法小店首页浏览");
    var loadingIconURL = "//mall-res.momentcam.net/newmall/CN/loading.gif";
    //===========新品推荐拼接数据=================
    jQuery.ajax({
        type: "get",
        async: true,
                    ...
                    for (var i = 0; i < Math.ceil(data.Data.length / 1) ; i++) {
                        for (var h = i * 1; h < (i * 1 + 1) ; h++) {
                            ...
                            html += '<div  class="NewModel  swiper-slide">' +
                                     '<img src="' + data.Data[i].Poster.replace("http://", "https://") + '" />' +
                                    ...
                                    '<div class="Author">' +
                                    '<img class="AuthorIcon" src="' + data.Data[i].UserIcon.replace("http://","https://") + '" />' +
                        ...
                        if (data.Data[i].LatestProducts.length > 0) {
                            ...
                            if (data.Data[i].LatestProducts.length == 3) {
                                ...
                                html1 += '<div class="StudioAuthor">' +
                                     ...
                                     '<img src="' + santutop.UserIcon.replace("http://", "https://") + '" /> </div>' +
                                     ...
                                     ' <div class="FollowBtn"  style="display:none;">关注</div> </div>' +
                                      ...
                                      '<img src="' + santu[0].Poster.replace("http://", "https://") + '" /></div>' +
                                      ' <div class="StudioPicListRight">' +
                                      '<img src="' + santu[1].Poster.replace("http://", "https://") + '" />' +
                                      '<img src="' + santu[2].Poster.replace("http://", "https://") + '" /> </div> </div>';
                            ...
                            if (data.Data[i].LatestProducts.length == 1) {
                                ...
                                html1 += '<div class="StudioAuthor">' +
                                      ...
                                      ' <div class="FollowBtn"  style="display:none;"> 关注</div> </div>' +
                                       ...
                                       '<img src="' + santu[0].Poster.replace("http://", "https://") + '"  class="yidt"/></div>  </div>';
                            ...
                            if (data.Data[i].LatestProducts.length == 2) {
                                ...
                                html1 += '<div class="StudioAuthor">' +
                                      ...
                                      ' <div class="FollowBtn"  style="display:none;"> 关注</div> </div>' +
                                       ...
                                       '<img src="' + santu[1].Poster.replace("http://", "https://") + '"  /> </div>' +
                                       '  </div>';
